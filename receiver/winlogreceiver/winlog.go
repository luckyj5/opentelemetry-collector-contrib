...
package winlogreceiver // import "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/winlogreceiver"
...
const typeStr = "winlog"

// NewFactory creates a factory for winlog receiver
func NewFactory() component.ReceiverFactory {
	return stanza.NewFactory(ReceiverType{})
}

// ReceiverType implements stanza.LogReceiverType
// to create a winlog receiver
...
func createDefaultConfig() *WinLogConfig {
	return &WinLogConfig{
...
func (f ReceiverType) BaseConfig(cfg config.Receiver) stanza.BaseConfig {
	return cfg.(*WinLogConfig).BaseConfig
}

// WinLogConfig defines configuration for the winlog receiver
